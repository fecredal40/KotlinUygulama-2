package com.ramazanyalcin.finaluygulamasi
...
class Ikinci_Sayfa : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val dosyayolu = "com.ramazanyalcin.finaluygulamasi"
        ...
        if (editTextTextPersonName.text.toString() == "Ramazan Yalcin"
            && editTextTextPersonName4.text.toString() == "02195076057"
        ) {
        ...
        editTextTextPersonName.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
                if (
                    editTextTextPersonName.text.toString() == "Ramazan Yalcin"
                    && editTextTextPersonName4.text.toString() == "02195076057"
                ) {
                    progressBar2.isVisible = true
                    Handler().postDelayed({
